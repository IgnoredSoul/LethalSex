...
namespace LethalSanity
{
    internal class Config
    {
        ...
        private void Init()
        {
            ...
            JObject Config = CreateEntry((config) =>
            {
                ...
                config.CreateShelf(
                    _name: "ChrAb",
                    _keys: "Enabled, ApplyVal, ApplySpeed, ResetVal, ResetSpeed",
                    _items: _config.Bind
                    (
                        section: "Post Processing",
                        key: "Chromatic Aberation",
                        defaultValue: "b:true, f:1.0, f:20.0, f:0.0, f:0.75",
                ...
                config.CreateShelf(
                    ...
                    (
                        section: "Post Processing",
                        key: "Lens Distortion",
                        defaultValue: "b:true, f:0.55, f:27.0, f:0.0, f:0.75",
                        description: "To even understand what the fuck is happening you've got to read the documentation / code on my github..."
                    ).Value,
                    _expected: ['b', 'f', 'f', 'f', 'f',]
                 );
                config.CreateShelf(
                    ...
                    (
                        section: "Post Processing",
                        key: "Lens Distortion",
                        defaultValue: "b:true, f:1.6, f:15.0, f:0.0, f:0.75",
                        description: "To even understand what the fuck is happening you've got to read the documentation / code on my github..."
                    ).Value,
                    _expected: ['b', 'f', 'f', 'f', 'f',]
                 );
                config.CreateShelf(
                    _name: "Vignette",
                    _keys: "Enabled, ApplyVal, ApplySpeed, ResetVal, ResetSpeed, Opacity, Smoothness",
                    _items: _config.Bind
                    (
                        section: "Post Processing",
                        key: "Vingette",
                        defaultValue: "b:true, f:0.5, f:25, f:0.1, f:0.75, f:0.5, f:25.0",
                        description: "To even understand what the fuck is happening you've got to read the documentation / code on my github..."
                    ).Value,
                    _expected: ['b', 'f', 'f', 'f', 'f', 'f', 'f']
                 );
                config.CreateShelf(
                    _name: "DOP",
                    _keys: "Enabled, SApplyVal, SApplySpeed, SResetVal, SResetSpeed, EApplyVal, EApplySpeed, EResetVal, EResetSpeed",
                    _items: _config.Bind
                    (
                        section: "Post Processing",
                        key: "Depth Of Field",
                        defaultValue: "b:true, f:5.0, f:25.0, f:2000.0, f:0.75, f:25.0, f:20.0, f:2000.0, f:0.75",
                        description: "To even understand what the fuck is happening you've got to read the documentation / code on my github..."
                    ).Value,
                    _expected: ['b', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 'f']
                 );
                config.CreateShelf(
                    _name: "CA",
                    _keys: "Enabled, ApplyVal, ApplySpeed, ResetVal, ResetSpeed",
                    ...
                    (
                        ...
                        defaultValue: "b:true, f:-64.0, f:25.0, f:0.0, f:0.75",
                        description: "To even understand what the fuck is happening you've got to read the documentation / code on my github..."
                    ).Value,
                    _expected: ['b', 'f', 'f', 'f', 'f']
                 );
                ...
                config.CreateShelf(
                    _name: "CL",
                    _keys: "Enabled, Max, Threshold, Reset",
                    _items: _config.Bind
                    (
                        section: "Camera Leaning",
                        key: "Camera Leaning Config",
                        defaultValue: "b:true, f:35.0, f:35.0, f:5.0",
                ...
                config.CreateShelf(
                    _name: "CL_EX",
                    _keys: "Default, Sprint, Fear, Insanity, Day, Daymode",
                    _items: _config.Bind
                    (
                        section: "Camera Leaning Multiplier",
                        key: "Camera Leaning Config",
                        defaultValue: "f:0.05, f:0.05, f:0.05, f:0.05, f:0.05, i:2",
                        description: "To even understand what the fuck is happening you've got to read the documentation / code on my github..."
                    ).Value,
                    _expected: ['f', 'f', 'f', 'f', 'f', 'i']
                 );
                ...
                config.CreateShelf(
                    _name: "FI_EX",
                    _keys: "Respawning, Delay, Log",
                    _items: _config.Bind
                    (
                        section: "Fake Items",
                        key: "Fake Items Extra",
                        defaultValue: "b:true, f:70.0, b:false",
            ...
            config = new DynConfig(Config);

            ConsoleManager.Log(config);
            LethalSex_Core.Main.mls.LogInfo(config);
        }
    }
}