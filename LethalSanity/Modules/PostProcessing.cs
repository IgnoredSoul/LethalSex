...
namespace LethalSanity.Modules
{
    internal class PostProcessing : LethalClass
    {
        ...
        {
            if (!Config.PP_ToggleModule) Unregister();
        }
        ...
        private void LateUpdate()
        {
            ...
            if (LocalPlayer.Insanity < Config.PP_Level1 && InsanityLvl1)
            {
            ...
            if (LocalPlayer.Insanity < Config.PP_Level2 && InsanityLvl2)
            {
                // Set this level of insanity to false
                InsanityLvl2 = false;
            ...
            if (LocalPlayer.Insanity < Config.PP_Level3 && InsanityLvl3)
            {
                // Set this level of insanity to false
                InsanityLvl3 = false;
